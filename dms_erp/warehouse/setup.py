...
CUSTOM_FIELDS = {
	"Warehouse": [
		{
			"fieldname": "pacific_bay_section",
			"fieldtype": "Section Break",
			"label": "Pacific Bay Attributes",
			"insert_after": "warehouse_type",
		},
		{"fieldname": "custom_bay_code", "fieldtype": "Data", "label": "Bay Code", "unique": 1, "insert_after": "pacific_bay_section"},
		...
		{"fieldname": "pacific_bay_column_break", "fieldtype": "Column Break", "insert_after": "custom_bay_status"},
		{"fieldname": "custom_dimensions", "fieldtype": "Select", "label": "Dimensions", "options": "\n".join(BAY_DIMENSIONS), "insert_after": "pacific_bay_column_break"},
	...
	"Stock Entry": [
		{
			"fieldname": "pacific_transfer_section",
			"fieldtype": "Section Break",
			"label": "Pacific Bay Transfer",
			"insert_after": "purpose",
			"depends_on": "eval:doc.purpose=='Material Transfer'",
		},
		{"fieldname": "custom_transfer_type", "fieldtype": "Select", "label": "Transfer Type", "options": "\n".join(TRANSFER_TYPES), "insert_after": "pacific_transfer_section"},
		...
		{"fieldname": "pacific_transfer_column_break", "fieldtype": "Column Break", "insert_after": "custom_transfer_reason"},
		{"fieldname": "custom_damage_type", "fieldtype": "Data", "label": "Damage Type", "insert_after": "pacific_transfer_column_break"},
